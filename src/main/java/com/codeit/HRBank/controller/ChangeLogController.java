...
public class ChangeLogController {
  ...
  public ResponseEntity<List<DiffDto>> getDiffsByLogId(@PathVariable Long id) {
    ...
    public ResponseEntity<CursorPageResponseChangeLogDto> find(
        ...
        CursorPageResponseChangeLogDto response = changeLogService.findByCondition(employeeNumber,type,memo,ipAddress,atFrom,atTo, idAfter, cursor, size, sortField, sortDirection);
